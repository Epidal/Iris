...
namespace Iris
{
	...
	public class ServerListEventArgs : EventArgs
	{
		...
		/// <summary>An array of servers (worlds) associated with this CABAL server.</summary>
		public Server[] ServerList { get; private set; }

		/// <summary>The time this event was fired.</summary>
		public DateTime Time { get; private set; }

		/// <summary>Provides data for the Iris.OnReceiveServerList event.</summary>
		public ServerListEventArgs()
		{
			IP = Globals.Client.Client.LocalEndPoint.ToString().Split(':')[0];
			ServerList = new List<Server>(Globals.ServerList.Values).ToArray();
			Time = DateTime.Now;
		}
	}
}